...
export default async (req, res) => {
  let testData = cache.get(`volumes`);
  ...
  if (testData) {
    ...
    data = await fetch(
      "https://min-api.cryptocompare.com/data/top/totaltoptiervol?limit=5&tsym=USD&api_key=54c69a67adfc783963d3589c5a08a40a5d619b0f22b94b1c79df9acc9129c5ff"
    ...
    cache.put(`volumes`, data, 7200000, function (key, value) {
